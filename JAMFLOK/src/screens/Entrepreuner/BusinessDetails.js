...
export default function BusinessDetails({ route, navigation }) {
  ...
  useEffect(() => {
    cargarDatosBusiness( idNegocio, setNegocio, setProductos, setEstadoNegocio, setLoading); cargarReviewBusiness(idNegocio, setReseñas);
  }, []);
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
            ...
            <View style={{ flex: 1, marginLeft: 15 }}>
              ...
              <View style={styles.rowButtons}>
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate("EditarNegocio", { idNegocio })}
                >
          ...
          <View style={styles.productosHeader}>
            ...
            <TouchableOpacity
              style={styles.btnAdd}
              onPress={() => navigation.navigate("AgregarProducto", { idNegocio })}
            >
